module.exports = {
  "status": "Powered By Damon", // kuch bhi likhdo yaha
  "statusType": "PLAYING", // WATCHING, PLAYING, LISTENING, STREAMING
  "bowner": ["672027578181353473"], // bot owner id here
  "logChannel": "1023161555296206878", // for logs
  "darkwebChannel": "1023161525722153020",  //  for the main channel where the main posts will be sent
  ...
  "webid": "1023183036340248596" || process.env.webid, //  these are the wobhooks for err and syndicate messages
  "webtoken": "N3a542B8mpmVwg3wq63hH0Ia_jVf55G7h51yf7nQeZT_acPyyQEH8DNn3CIGqzLLeND3" || process.env.webtoken, //  these are the wobhooks for err and syndicate messages
